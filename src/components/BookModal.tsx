...
export default function BookModal({
  ...
  const items = useMemo<ItemEntry[]>(() => {
    const groups = [
      ...
      { id: 'mixers', label: '调和材料', mark: '调', values: recipesData.ingredients.mixers },
      { id: 'flavors', label: '风味素材', mark: '味', values: recipesData.ingredients.flavors },
    ];
  ...
  const itemSections = useMemo(
    () =>
      [
        ...
        { id: 'mixers', label: '调和材料' },
        { id: 'flavors', label: '风味素材' },
      ].map(section => ({
        ...section,
