...
export interface DialogueTranscriptEntry { speaker: string; text: string; }
export interface DialogueProgressSnapshot { playerText: string; relationshipValues: Record<'affection', number>; completedEventIds: string[]; selectedOptionIds: string[]; unlockedChapterIds: string[]; currentNodeId: string | null; observedFeatureIds: string[]; lastDrinkSuccess: boolean | null; recentTranscript: DialogueTranscriptEntry[]; }
